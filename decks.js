...
var sampleLevel={
  ...
  content:[
      {
		  set: [oC.buggy,tC.to0,tC.rough,tC.to0,tC.to0,tC.level,tC.up,tC.level,tC.up,tC.level,tC.up,tC.to0,tC.to0,tC.to0,tC.to0]
	  },
	  {
		  set: [tC.up,tC.level,tC.level,tC.to100,tC.to100,tC.to150,tC.level,tC.level,tC.rough],
		  distance: 4000
	  },
	  {
